...
local name = read_config("table_prefix") or "download_stats_funnelcake"
local schema = {
--   column name                , field type  , length , attributes , field name
    {"timestamp"                , "TIMESTAMP" , nil    , "SORTKEY",   "Timestamp"                        },
    {"ping_version"             , "VARCHAR"   , 16     , nil,         "Fields[ping_version]"             },
    ...
    {"profile_cleanup_prompt"   , "INTEGER"   , nil    , nil,         "Fields[profile_cleanup_prompt]"   },
    {"profile_cleanup_requested", "BOOLEAN"   , nil    , nil,         "Fields[profile_cleanup_requested]"},
}
